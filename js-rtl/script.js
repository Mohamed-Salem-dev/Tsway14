...
$(function () {
	let scroll = $(document).scrollTop();
	let navHeight = $('.box-nav-all2').outerHeight();

	$(window).scroll(function () {
		var scrolled = $(document).scrollTop();

		if (scrolled > navHeight) {
			$('.box-nav-all2').addClass('animate');
		} else {
			$('.box-nav-all2').removeClass('animate');
		}

		if (scrolled > scroll) {
			$('.box-nav-all2').removeClass('sticky');

		} else {
			$('.box-nav-all2').addClass('sticky');
		}
		scroll = $(document).scrollTop();
...
$(function () {
	let scroll = $(document).scrollTop();
	let navHeight = $('.nav-mdi').outerHeight();

	$(window).scroll(function () {
		var scrolled = $(document).scrollTop();

		if (scrolled > navHeight) {
			$('.nav-mdi').addClass('animate');
		} else {
			$('.nav-mdi').removeClass('animate');
		}

		if (scrolled > scroll) {
			$('.nav-mdi').removeClass('sticky');

		} else {
			$('.nav-mdi').addClass('sticky');
		}
		scroll = $(document).scrollTop();
